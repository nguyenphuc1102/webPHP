...
class cart
{
	...
	public function add_to_cart($quantity, $id)
	{
		...
		if ($result_check_cart) {
			...
			while ($result_cart = $result_check_cart->fetch_assoc()) {
				$this->update_quantity_cart($result_cart['quantity'] + $quantity, $result_cart['cartId']);
			}
	...
	public function update_quantity_cart($quantity, $cartId)
	{
		...
		// $qtyOld = Session::get('qty');
		// Session::set('qty', $quantity+$qtyOld);
	...
	public function del_product_cart($cartid)
	{
		...
		if ($result) {
			...
			header("refresh:2;Location:index.php?action=cart");
			// return $msg;
